...
saturation_fields <- c(
  'saturation:sum:Proxy/dc:title', 'saturation:average:Proxy/dc:title', 'saturation:normalized:Proxy/dc:title', 
  ...
  'saturation:average:Proxy/dc:description', 'saturation:normalized:Proxy/dc:description', 'saturation:sum:Proxy/dc:creator',
  'saturation:average:Proxy/dc:creator', 'saturation:normalized:Proxy/dc:creator', 'saturation:sum:Proxy/dc:publisher',
  'saturation:average:Proxy/dc:publisher', 'saturation:normalized:Proxy/dc:publisher', 'saturation:sum:Proxy/dc:contributor',
  'saturation:average:Proxy/dc:contributor', 'saturation:normalized:Proxy/dc:contributor', 'saturation:sum:Proxy/dc:type',
  'saturation:average:Proxy/dc:type', 'saturation:normalized:Proxy/dc:type', 'saturation:sum:Proxy/dc:identifier',
  'saturation:average:Proxy/dc:identifier', 'saturation:normalized:Proxy/dc:identifier', 'saturation:sum:Proxy/dc:language',
  'saturation:average:Proxy/dc:language', 'saturation:normalized:Proxy/dc:language', 'saturation:sum:Proxy/dc:coverage',
  'saturation:average:Proxy/dc:coverage', 'saturation:normalized:Proxy/dc:coverage', 'saturation:sum:Proxy/dcterms:temporal',
  ...
  'saturation:normalized:Proxy/dcterms:spatial', 'saturation:sum:Proxy/dc:subject', 'saturation:average:Proxy/dc:subject',
  'saturation:normalized:Proxy/dc:subject', 'saturation:sum:Proxy/dc:date', 'saturation:average:Proxy/dc:date',
  'saturation:normalized:Proxy/dc:date', 'saturation:sum:Proxy/dcterms:created', 'saturation:average:Proxy/dcterms:created',
  'saturation:normalized:Proxy/dcterms:created', 'saturation:sum:Proxy/dcterms:issued',
  'saturation:average:Proxy/dcterms:issued', 'saturation:normalized:Proxy/dcterms:issued', 'saturation:sum:Proxy/dcterms:extent',
  'saturation:average:Proxy/dcterms:extent', 'saturation:normalized:Proxy/dcterms:extent', 'saturation:sum:Proxy/dcterms:medium',
  ...
  'saturation:normalized:Proxy/dcterms:isPartOf', 'saturation:sum:Proxy/dc:format', 'saturation:average:Proxy/dc:format',
  'saturation:normalized:Proxy/dc:format', 'saturation:sum:Proxy/dc:source', 'saturation:average:Proxy/dc:source',
  'saturation:normalized:Proxy/dc:source', 'saturation:sum:Proxy/dc:rights', 'saturation:average:Proxy/dc:rights',
  'saturation:normalized:Proxy/dc:rights', 'saturation:sum:Proxy/dc:relation', 'saturation:average:Proxy/dc:relation',
  ...
  'saturation:sum:Proxy/edm:year', 'saturation:average:Proxy/edm:year', 'saturation:normalized:Proxy/edm:year',
  'saturation:sum:Proxy/edm:userTag', 'saturation:average:Proxy/edm:userTag', 'saturation:normalized:Proxy/edm:userTag',
  'saturation:sum:Proxy/ore:proxyIn', 'saturation:average:Proxy/ore:proxyIn', 'saturation:normalized:Proxy/ore:proxyIn',
  'saturation:sum:Proxy/ore:proxyFor', 'saturation:average:Proxy/ore:proxyFor', 'saturation:normalized:Proxy/ore:proxyFor',
